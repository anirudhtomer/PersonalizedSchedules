...
getRandomEffectDist = function(object, patient_data, 
                               latest_survival_time=0, earliest_failure_time=Inf, 
                               psaDist = "Tdist", TdistDf=3, M=500){
...
getExpectedFutureOutcomes = function(object, post_b_beta, patient_data, 
                                     latest_survival_time=0, earliest_failure_time=Inf, 
...
environment(getRandomEffectDist) = asNamespace("JMbayes")
